...
FineAudioBuffer::FineAudioBuffer(AudioDeviceBuffer* device_buffer,
		int desired_frame_size_bytes, int sample_rate) :
		device_buffer_(device_buffer), desired_frame_size_bytes_(
				desired_frame_size_bytes), sample_rate_(sample_rate), samples_per_10_ms_(
				sample_rate_ * 10 / 1000), bytes_per_10_ms_(
				samples_per_10_ms_ * sizeof(int16_t)), cached_buffer_start_(0), cached_bytes_(
				0) {
