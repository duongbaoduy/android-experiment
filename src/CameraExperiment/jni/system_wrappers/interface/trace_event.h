...
public:
	...
	explicit TraceID(const void* id, unsigned char* flags) :
			data_(
					static_cast<unsigned long long>(reinterpret_cast<unsigned long>(id))) {
...
static inline void AddTraceEvent(char phase,
		const unsigned char* category_enabled, const char* name,
	...
	void AddEventIfEnabled() {
		...
		if (*p_data_->category_enabled) {
			TRACE_EVENT_API_ADD_TRACE_EVENT(TRACE_EVENT_PHASE_END,
					p_data_->category_enabled, p_data_->name, kNoEventId,
