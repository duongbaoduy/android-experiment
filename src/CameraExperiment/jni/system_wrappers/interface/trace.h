...
public:
	...
	static void Add(const TraceLevel level, const TraceModule module,
...
extern "C" {
#endif
extern void webrtc_trace_create(); /* ANSI C prototypes */
#ifdef __cplusplus
}
#endif
